...
class DatabaseInstance {
  final String databaseName = "perpustakaan1.db";
  final int databaseVersion = 2;

  // Atribut di Model Transaksi
  final String namaTabel = 'perpustakaan1';
  final String id = 'id';
  final String name = 'name';
  final String judul = 'judul_buku';
  final String type = 'type';
  final String total = 'total';
  final String tglawl ='tgl_awl';
  final String tglakhr ='tgl_akhr';
  ...
  Future _onCreate(Database db, int version) async {
    await db.execute(
        'CREATE TABLE ${namaTabel} ($id INTEGER PRIMARY KEY, $name TEXT NULL, $judul TEXT NULL, $type INTEGER, $total INTEGER,$tglawl TEXT NULL, $tglakhr TEXT NULL, $createdAt TEXT NULL, $updatedAt TEXT NULL)');
  }
